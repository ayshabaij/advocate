...
class AdvocatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advocate" do
    assert_difference('Advocate.count') do
      post advocates_url, params: { advocate: { email: @advocate.email, password: 'secret', password_confirmation: 'secret' } }
    end
  ...
  test "should update advocate" do
    patch advocate_url(@advocate), params: { advocate: { email: @advocate.email, password: 'secret', password_confirmation: 'secret' } }
